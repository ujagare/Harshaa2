            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-5 justify-center">
                <Link to="/services">
                  <Button
                    size="lg"
                    className="gold-gradient text-white font-bold text-lg px-8 py-7 hover:opacity-95 shadow-lg hover:shadow-xl transition-all duration-200 active:scale-[0.98] group rounded-xl"
                  >
                    Explore services
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {features.map((feature, index) => (
                ...
                >
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary/30 to-accent/30 flex items-center justify-center mb-6 shadow-inner">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
              ...
              >
                <div className="aspect-[4/5] rounded-3xl overflow-hidden mystical-border shadow-2xl">
                  <img
                    src="https://images.unsplash.com/photo-1653152597201-984b79f98316"
                    alt="Peaceful meditation space with candles and sacred objects"
